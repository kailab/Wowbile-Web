...
<link href="bundles/sensiodistribution/webconfigurator/css/install.css"
		...
		<div id="symfony-content">
			<div class="symfony-blocks-install">
				<div class="symfony-block-logo">
					<img
						src="bundles/sensiodistribution/webconfigurator/images/logo-big.gif"
						alt="sf_symfony" />
				</div>
				...
				<div class="symfony-block-content">
					...
					<p>
						...
						project. You can also do the same by editing the ‘<strong>app/config/parameters.ini</strong>’
						file directly.
					</p>
